  ...
  return (
    <div className="flex justify-between gap-x-2 border-y pl-4 pr-3 py-4">
      <div className="flex items-center gap-2">
        ...
        <div className={cn(`overflow-hidden overflow-ellipsis text-sm md:text-base text-mauve12`, checked && "text-mauve8")}>ああ</div>
      </div>
      {checked && (
        <button className="w-fit whitespace-nowrap rounded-md px-2 text-tomato9 text-sm md:text-base hover:bg-mauve3">削除</button>
      )}
    </div>
  );
};
