...
import { editChefFormSchema } from "../(chefs)/_components/edit-chef-form";
...
export const editChef = zact(editChefFormSchema)(async ({ uid, name, bio, urls }): Promise<EditChefResult> => {
