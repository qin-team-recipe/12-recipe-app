...
import { Check, CheckCircle2, ChevronDown, ChevronUp, MoreVertical, Trash } from "lucide-react";
...
export const MemoListTile = ({ form, index, remove }: Props) => {
  ...
  const updateMemoTitle = useCallback(async () => {
    setIsEditing(false);
                    ...
                    <CommandList>
                      <CommandItem className="text-mauve11">
                        ...
                        >
                          ...
                          <span>{isChecked ? "チェックを外す" : "チェックを付ける"}</span>
                        </button>
                      </CommandItem>
                      {index !== 0 && (
                        <CommandItem className="text-mauve11">
                          <button
                            ...
                            onClick={async () => {
                              ...
                              // orderの更新
                              memos[index].order = target.order - 1;
                              memos[index - 1].order = target.order;
